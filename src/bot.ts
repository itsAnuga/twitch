    ...
    case 'notification':
      switch (data.metadata.subscription_type) {
        case 'channel.chat.message':
            ...
            // sendChatMessage('message', token, env, ids)
 ...
 * @param {Object} ids
 */
const registerEventSubListeners = async (websocketSessionId, token, env, ids) => {
...
export { handleWebSocketMessage, registerEventSubListeners, sendChatMessage, WebSocketClient }
